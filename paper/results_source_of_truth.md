...
1. Among all tested loss variants, the family of M2-robust gamma losses dominates in multi-seed Sharpe.
...
6. Single-seed baseline comparison at seed 42 shows that traditional MSE/MedSE, MADL, and GMADL each fail to produce positive Sharpe that is also robust, while hybrid multiplicative variant M1 and additive variant A3 yield the best same-window single-seed Sharpes among baseline-style losses.
