...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Title page — matches mid-term report style with logo
\title{\bfseries {\sc{ Final Year Project Final Report \\[1cm]
Loss Function Design for Cross-Sectional Stock-Return Prediction \\[0.5cm]
