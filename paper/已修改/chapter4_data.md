...
The X1 feature set contributes 10 engineered columns (5 horizons × 2 variables). The model input is 15 columns comprising these 10 X1 columns together with the 5 base panel columns (RET, VOL, SHROUT, r, to) that `assemble_feature_matrix` retains.
...
**Table 4.3 — Complete 15-column model input for X1.**
